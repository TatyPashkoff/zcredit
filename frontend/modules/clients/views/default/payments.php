...
<?= $this->render('_header') ?>
    ...
    <div class="reg-container black-bg w800 mb-30px">
        ...
        <?= $this->render('_menu',['active'=>'payments']) ?>


        <h3 class="title"><?=Yii::t('app','Пополнение баланса')?></h3>

        <div class="row">
            <div class="col-12">
                <input type="text" id="summ" class="form-control" placeholder="<?=Yii::t('app','Введите сумму')?>">
            </div>
        </div>
...
$price = 100; //$credit_items->credit->price * 100; // PAYME в тийинах
...
$transAmount = number_format($price, 2, '.', '');
...
$transAmount = number_format($price *100, 2, '.', '');
