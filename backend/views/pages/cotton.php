    ...
    <div class="pages-form">
        ...
        <div class="col-md-12">
            ...
            <div class="tab-pane" id="tab_photo">
                ...
                <div id="box1" class="container-file"  style="display: <?= \common\helpers\FileHelper::fileExist('/uploads/block/thumb/cotton_thumb.jpg') ? 'block': 'none' ?>">
                    <img width="300px" id="img_preview_banner" class="thumb" src="<?= '/uploads/block/thumb/cotton_thumb.jpg?v=' . rand(1000000,9999999) ?>" alt="">
