...
$company_type = '';
$company_name = '';
if(isset($credit->supplier->company)){
...
$this->title = "Детализация кредита № ".$credit->id;
?>
    ...
    <div >
        <h1 class="container__headline" style="margin: 0px!important;">
            ...
            <br/>
            <?=$prefix_act = $credit->prefix_act ? ' № ' . $credit->prefix_act : '' ?> ОТ <?=date('d.m.Y',$credit->created_at) ?>
        </h1>
...
//                        $sum += $price_nds;
            ...
            <div class="check-container__transactions">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td scope="col">платеж</td>
                        <td scope="col">остаток</td>
                    </tr>
                    </thead>
                    <tbody>
            ...
            <div>
                ...
                <div>
                    5. Настоящий Акт сформирован в Информационной системе «ZMARKET» (www.zmarket.uz), а также распечатан и подписан Сторонами в 2 (двух) экземплярах, один из которых находится у Продавца, второй - у Покупателя.
                </div>
            </div>
            ...
            <div style="margin-bottom: 0px;">
                ...
                <div>
                    ...
                    на основании доверенности от (<?= isset($credit->supplier) ? date('d.m.Y',$credit->supplier->created_at) : 'Поставщик удален из системы' ?>)
                    Ответственное лицо
                </div>
