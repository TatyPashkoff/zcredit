...
<div class="user-index">
    ...
    <p>
        ...
        if( !Yii::$app->user->isGuest && Yii::$app->user->identity->role == 9 && Yii::$app->controller->id == 'managers'){ ?>
            <?= Html::a('Добавить', ['managers/create-admin'], ['class' => 'btn btn-success']) ?>
        <?php } ?>
        ...
        'columns' => [
           ...
           /* [
            ...
            [
                'attribute'=>'role',
                'format' => 'html',
                'filter'=> $roles = [1=>'user',3=>'Менеджер KYC',4=>'Api пользователь',5=>'Менеджер',9=>'Админ'],
                'content'=>function($data) {
                    $roles = [1=>'Пользователь',3=>'Менеджер KYC',4=>'Api пользователь',5=>'Менеджер', 9=>'Админ'];
